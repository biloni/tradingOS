...
class TestOperatingModeEndpoint:
    def test_defaults_to_research_only(self, client: TestClient) -> None:
    ...
    def test_reports_paper_mode_environment_label(
    ...
    def test_reports_live_mode_environment_label(
        self, client: TestClient, monkeypatch: pytest.MonkeyPatch
    ) -> None:
