...
/**
 * Relocated from `app/page.tsx` (Revision Prompt R2) when the Morning
 * Decision Dashboard became the default landing route
 * (docs/UX_MAP.md's R1 delta). Kept, not deleted — this is the Phase
 * 1-7 dashboard against the (now-retired, Phase 8/ADR-044) old API
 * shape; still reachable at this URL for reference, not linked from the
 * primary nav.
 */
const QUICK_LINKS = [
  {
